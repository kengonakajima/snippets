    ...
    return React.createElement(Box, { flexDirection: "column" },
        React.createElement(Box, { marginBottom: 1 },
            React.createElement(Text, null,
                ...
                selectedElement && React.createElement(Text, null, " Selected: ", selectedElement.type, " (ID: ", selectedElement.id, ")")
            )
        ),
        React.createElement(Box, { marginBottom: 1 },
            React.createElement(Text, null,
                "Controls: Arrows (move), Space (draw), D/B/I/S/N (modes), P (simulate), C (clear), Q (quit)",
                mode === 'interact' && selectedElement && React.createElement(Text, null, " | Press 1 (message) or 2 (navigate) to add interaction")
            )
        ),
                        ...
                        React.createElement(Text, null,
                            row.map((cell, x) => {
                                ...
                                if (x === cursor.x && y === cursor.y) {
                                    return React.createElement(Text, { key: x, inverse: true }, cell);
                                } else if (isSelected) {
                                    return React.createElement(Text, { key: x, color: "green" }, cell);
                                }
                                return cell;
                            }).join('')
                        )
