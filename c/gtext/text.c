...
int main (int argc, char *argv[])
{
  ...
  /* GtkText ウィジェットに垂直スクロールバーを追加 */
  vscrollbar = gtk_vscrollbar_new (GTK_TEXT (text)->vadj);
  gtk_table_attach (GTK_TABLE (table), vscrollbar, 1, 2, 0, 1,
                    GTK_FILL, GTK_EXPAND | GTK_SHRINK | GTK_FILL, 0, 0);
  gtk_widget_show (vscrollbar);

  /* システムカラーマップを取得し、赤を割り当てる */
...
/*  fixed_font = gdk_font_load ("-misc-fixed-medium-r-*-*-*-140-*-*-*-*-*-*");*/
  fixed_font = gdk_font_load ("-misc-fixed-medium-r-normal--14-130-75-75-c-140-jisx0208.1983-0" );
  
      

  /* ウィジェットの実体化でウィンドウを作成することで、テキスト挿入に備える */
  gtk_widget_realize (text);

  /* 複数の更新に対応するべく、テキストウィジェットを凍結 */ 
  ...
  /* テキストウィジェットを解凍することで、更新を許可して表示できるよ
   * うにする */
