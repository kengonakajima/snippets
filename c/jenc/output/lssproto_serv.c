...
*/
	...
	if( strcmp( funcname , "W" ) == 0 ){
		char* direction;
		int id;
		direction = lssproto_wrapStringAddr( lssproto_stringwrapper[1] , lssproto_demkstr_string( lssproto.token_list[2] ));
		id = lssproto_demkstr_int( lssproto.token_list[3] );
		lssproto_W_recv( fd,direction,id);
	}
/*
...
*/
	...
	if( strcmp( funcname , "AD" ) == 0 ){
		int dir;
		dir = lssproto_demkstr_int( lssproto.token_list[2] );
		lssproto_AD_recv( fd,dir);
	}
/*
...
*/
	...
	if( strcmp( funcname , "MGD" ) == 0 ){
		int dir;
		char* pattern;
		dir = lssproto_demkstr_int( lssproto.token_list[2] );
		pattern = lssproto_wrapStringAddr( lssproto_stringwrapper[2] , lssproto_demkstr_string( lssproto.token_list[3] ));
		lssproto_MGD_recv( fd,dir,pattern);
	}
/*
...
*/
	...
	if( strcmp( funcname , "SKD" ) == 0 ){
		int dir;
		int index;
		dir = lssproto_demkstr_int( lssproto.token_list[2] );
		index = lssproto_demkstr_int( lssproto.token_list[3] );
...
*/
	...
	if( strcmp( funcname , "ID" ) == 0 ){
		...
		int itemindex;
		dir = lssproto_demkstr_int( lssproto.token_list[2] );
		itemindex = lssproto_demkstr_int( lssproto.token_list[3] );
		lssproto_ID_recv( fd,dir,itemindex);
	}
/*
...
*/
	...
	if( strcmp( funcname , "ST" ) == 0 ){
		int titleindex;
		titleindex = lssproto_demkstr_int( lssproto.token_list[2] );
...
*/
	...
	if( strcmp( funcname , "DI" ) == 0 ){
		int itemindex;
		itemindex = lssproto_demkstr_int( lssproto.token_list[2] );
		lssproto_DI_recv( fd,itemindex);
	}
/*
...
*/
	...
	if( strcmp( funcname , "DG" ) == 0 ){
		int amount;
		amount = lssproto_demkstr_int( lssproto.token_list[2] );
		lssproto_DG_recv( fd,amount);
	}
/*
...
*/
	...
	if( strcmp( funcname , "SKUP" ) == 0 ){
		int skillindex;
		skillindex = lssproto_demkstr_int( lssproto.token_list[2] );
		lssproto_SKUP_recv( fd,skillindex);
	}
/*
...
*/
	...
	if( strcmp( funcname , "AAB" ) == 0 ){

		lssproto_AAB_recv( fd);
	}
/*
...
*/
	...
	if( strcmp( funcname , "RAB" ) == 0 ){
		int index;
		index = lssproto_demkstr_int( lssproto.token_list[2] );
		lssproto_RAB_recv( fd,index);
	}
/*
...
*/
	...
	if( strcmp( funcname , "TK" ) == 0 ){
		char* message;
		int color;
		message = lssproto_wrapStringAddr( lssproto_stringwrapper[1] , lssproto_demkstr_string( lssproto.token_list[2] ));
		color = lssproto_demkstr_int( lssproto.token_list[3] );
		lssproto_TK_recv( fd,message,color);
	}
/*
...
*/
	...
	if( strcmp( funcname , "S" ) == 0 ){
		char* category;
		category = lssproto_wrapStringAddr( lssproto_stringwrapper[1] , lssproto_demkstr_string( lssproto.token_list[2] ));
...
*/
	...
	if( strcmp( funcname , "ClientLogin" ) == 0 ){
		char* cdkey;
		char* passwd;
		cdkey = lssproto_wrapStringAddr( lssproto_stringwrapper[1] , lssproto_demkstr_string( lssproto.token_list[2] ));
		passwd = lssproto_wrapStringAddr( lssproto_stringwrapper[2] , lssproto_demkstr_string( lssproto.token_list[3] ));
...
*/
	...
	if( strcmp( funcname , "CreateNewChar" ) == 0 ){
		...
		int imgno;
		char* option;
		charname = lssproto_wrapStringAddr( lssproto_stringwrapper[1] , lssproto_demkstr_string( lssproto.token_list[2] ));
		imgno = lssproto_demkstr_int( lssproto.token_list[3] );
		option = lssproto_wrapStringAddr( lssproto_stringwrapper[3] , lssproto_demkstr_string( lssproto.token_list[4] ));
		lssproto_CreateNewChar_recv( fd,charname,imgno,option);
	}
/*
...
*/
	...
	if( strcmp( funcname , "ChangePasswd" ) == 0 ){
		char* oldpasswd;
		char* newpasswd;
		oldpasswd = lssproto_wrapStringAddr( lssproto_stringwrapper[1] , lssproto_demkstr_string( lssproto.token_list[2] ));
		newpasswd = lssproto_wrapStringAddr( lssproto_stringwrapper[2] , lssproto_demkstr_string( lssproto.token_list[3] ));
		lssproto_ChangePasswd_recv( fd,oldpasswd,newpasswd);
	}
/*
...
void lssproto_W_send( int fd,int id,int x,int y )
{
	...
	strncat( lssproto.work , lssproto_mkstr_int( x ) ,lssproto.workbufsize );
	strncat( lssproto.work , lssproto_mkstr_int( y ) ,lssproto.workbufsize );
...
{
	lssproto_CreateHeader( lssproto.work , "NAB" );
	strncat( lssproto.work , lssproto_mkstr_string( data ) ,lssproto.workbufsize );
	lssproto_Send( fd , lssproto.work );
}
/*
...
{
	lssproto_CreateHeader( lssproto.work , "T" );
	strncat( lssproto.work , lssproto_mkstr_int( charindex ) ,lssproto.workbufsize );
...
{
	lssproto_CreateHeader( lssproto.work , "CA" );
	strncat( lssproto.work , lssproto_mkstr_string( data ) ,lssproto.workbufsize );
	lssproto_Send( fd , lssproto.work );
}
/*
...
{
	lssproto_CreateHeader( lssproto.work , "R" );
	strncat( lssproto.work , lssproto_mkstr_int( result ) ,lssproto.workbufsize );
	strncat( lssproto.work , lssproto_mkstr_string( data ) ,lssproto.workbufsize );
	lssproto_Send( fd , lssproto.work );
}
/*
...
{
	lssproto_CreateHeader( lssproto.work , "D" );
	strncat( lssproto.work , lssproto_mkstr_int( category ) ,lssproto.workbufsize );
	strncat( lssproto.work , lssproto_mkstr_int( dx ) ,lssproto.workbufsize );
	strncat( lssproto.work , lssproto_mkstr_int( dy ) ,lssproto.workbufsize );
	strncat( lssproto.work , lssproto_mkstr_string( data ) ,lssproto.workbufsize );
	lssproto_Send( fd , lssproto.work );
}
/*
...
void lssproto_ClientLogin_send( int fd,char* result )
{
	...
	strncat( lssproto.work , lssproto_mkstr_string( result ) ,lssproto.workbufsize );
	lssproto_Send( fd , lssproto.work );
}
/*
