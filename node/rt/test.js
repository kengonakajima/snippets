...
class RealtimeSpeedTest {
  ...
  generateTestData() {
    ...
    console.log(`\nGenerated test data: ${JSON.stringify(numbers)}`);
    console.log(`Expected odd numbers: ${JSON.stringify(odds)}`);
  ...
  async runSingleTest() {
    ...
    console.log(`\nRound ${result.round}: ${result.isCorrect ? '✓ CORRECT' : '✗ INCORRECT'} ` +
...
async function main() {
  ...
  console.log('OpenAI Realtime API Speed Test (Test Mode - 3 rounds)');
